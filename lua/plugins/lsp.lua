...
local on_attach = function(client, buffer_number)
	...
	vim.keymap.set("n", "gd", vim.lsp.buf.definition, { desc = "LSP: [G]oto [D]definition", buffer = buffer_number })
	...
	vim.keymap.set(
		...
		{ desc = "LSP: [T]ype [D]definition", buffer = buffer_number }
	)
end
	...
	},
	{
		...
		config = function()
			...
			local servers = {
				...
				eslint = {
					settings = {
						validate = (not utils.is_deno_project() and "on" or "off"),
						-- experimental = {
						-- 	useFlatConfig = true,
						-- },
					},
